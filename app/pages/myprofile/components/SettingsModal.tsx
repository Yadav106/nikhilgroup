                ...
                <div className="space-y-12">
                    <div className="border-gray-900/10 border-b pb-12">
                        ...
                        <div className="mt-10 flex flex-col gap-y-8">
                            ...
                            <Input disabled={isLoading} label="Phone" id="phone" errors={errors} required register={register}/>
                            <div>
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    ...
                                    <CldUploadButton options={{maxFiles: 1}} onUpload={handleUpload} uploadPreset="zidrmycz">
